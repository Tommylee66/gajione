...
export const REPORTS: ReportDef[] = [
  ...
  // --- BPJS -----------------------------------------------------------------
  {
    ...
    scope: 'period',
    name: 'BPJS (차수)',
    description: '차수별 프로그램별 기여금 · 직원/회사 부담 구분 · SIPP 대사용',
    columns: [
      ...EMPLOYEE_COLS,
      'bpjs_base',
      'kesehatan',
  ...
  },
  {
    ...
    scope: 'range',
    name: 'BPJS (기간)',
    description: '기간 내 직원별 BPJS 기여금 상세 (직원/회사 부담)',
    columns: ['period', ...EMPLOYEE_COLS, 'employee_total', 'employer_total'],
  },
  {
    id: 'bpjs_annual',
    category: 'bpjs',
    scope: 'annual',
    name: 'BPJS 연간',
    description: '연간 누적 기여금 · 회사/직원 부담분 구분',
    columns: [
      ...EMPLOYEE_COLS,
      'kesehatan_total',
      'jht_total',
